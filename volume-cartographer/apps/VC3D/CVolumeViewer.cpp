...
void CVolumeViewer::setCompositeHistogramEqualize(bool equalize)
{
...
void CVolumeViewer::setCompositeIsoCutoff(int value)
{
    value = std::clamp(value, 0, 255);
    if (value != _composite_iso_cutoff) {
        _composite_iso_cutoff = value;
        if (_composite_enabled) {
            renderVisible(true);
        }
    }
