...
template bool isFiniteVec<cv::Vec3f>(const cv::Vec3f& v);
template bool isFiniteVec<cv::Vec3d>(const cv::Vec3d& v);

template bool isSentinelInvalid<cv::Vec3f>(const cv::Vec3f& v);
template bool isSentinelInvalid<cv::Vec3d>(const cv::Vec3d& v);

template double triangleArea<cv::Vec3f>(const cv::Vec3f& a, const cv::Vec3f& b, const cv::Vec3f& c);
template double triangleArea<cv::Vec3d>(const cv::Vec3d& a, const cv::Vec3d& b, const cv::Vec3d& c);

template double quadArea<cv::Vec3f>(const cv::Vec3f& p00, const cv::Vec3f& p10, const cv::Vec3f& p01, const cv::Vec3f& p11);
template double quadArea<cv::Vec3d>(const cv::Vec3d& p00, const cv::Vec3d& p10, const cv::Vec3d& p01, const cv::Vec3d& p11);

template double surfaceArea<cv::Vec3f>(const cv::Mat_<cv::Vec3f>& points);
template double surfaceArea<cv::Vec3d>(const cv::Mat_<cv::Vec3d>& points);
