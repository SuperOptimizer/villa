...
// ============================================================================
//  Explicit template instantiations for thresholdedDistance
// ============================================================================

#include "vc/core/types/ChunkedTensor_impl.hpp"

template class Chunked3d<uint8_t, thresholdedDistance>;
template class Chunked3dAccessor<uint8_t, thresholdedDistance>;
template class CachedChunked3dInterpolator<uint8_t, thresholdedDistance>;
