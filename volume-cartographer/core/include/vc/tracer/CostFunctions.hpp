...
struct NormalFitQualityWeightField {
    NormalFitQualityWeightField(std::unique_ptr<zarr::Zarr>&& rms_ds,
                                std::unique_ptr<zarr::Zarr>&& frac_ds,
                                float scale,
...
private:
    ...
    float _scale;
    std::unique_ptr<zarr::Zarr> _rms_ds;
    std::unique_ptr<zarr::Zarr> _frac_ds;
